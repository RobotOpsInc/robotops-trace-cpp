...
#ifndef ROBOTOPS_TRACE__DETAIL__BATCH_PROCESSOR_HPP_
#define ROBOTOPS_TRACE__DETAIL__BATCH_PROCESSOR_HPP_
...
#endif  // ROBOTOPS_TRACE__DETAIL__BATCH_PROCESSOR_HPP_
